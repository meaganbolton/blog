...
<a href = "https://github.com/meaganbolton/Chess.git" target="_blank">Click here for a Github Repo to a chess game I coded!</a> Fair warning it's a lot of code, it contains everything from the API to THE UI to the game logic to making a database to store information in SQL.
